# Mapping the risk environment with oepsData

`oepsData` is a package created to help interact more easily with the opioid risk environment data within OEPS. The main package offerings come in the form of two functions: `load_oeps_dictionary`, which loads a basic data dictionary; and `load_oeps`, which loads OEPS data. 
